                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100%"
                                                ...
                                                <option value="Static Banner" {{$banner['banner_type']=='Static Banner'?'selected':''}}>Static Banner</option>
                                                <option value="Slider Banner" {{$banner['banner_type']=='Slider Banner'?'selected':''}}>Slider Banner</option>
                                            </select>
                                        </div>
