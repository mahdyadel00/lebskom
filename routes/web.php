...
Route::post('cashew', 'CashewController@paymentProcess')->name('cashew');
Route::post('onlinePyment', 'Onlinep@paymentProcess')->name('onlinep');
...
Route::get('/contact-mobile', function (){
    return view('web-views.contact-mobile'); 
});
